...
class LengthArgument {
    public static void main(String[] args) {
        ...
        average(78, 32, 34, 45 , 4, 56, 56 ,54 , 45, 23, 7, 34, 234, 234, 234);
    }

    // create a method
    public static void average(int ... numbers) { // put ellipses before the variable name to indicate that you don't know how many arguments you would like to add
        int total = 0;
